                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block " >
                            ...
                            <div class="block-content collapse in">
									...
									<?php 
								$query_students = mysqli_query($connection,"select * from students  ")or die(mysqli_error());
								...
								<?php 
								$query_class = mysqli_query($connection,"select * from class")or die(mysqli_error());
								...
								$query_nursery = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Nursery'")or die(mysqli_error());
								...
								<?php 
								$query_primary = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Primary'")or die(mysqli_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>PRIMARY STUDENTS</strong>
										...
										<?php 
								$query_secondary = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Secondary'")or die(mysqli_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>SECONDARY STUDENTS</strong>
										...
										<?php 
								$query_admin = mysqli_query($connection," select * from users where status='administrator' ")or die(mysqli_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>ADMIN USERS</strong>
										...
										<?php 
								$query_normal = mysqli_query($connection," select * from users where status='normal'")or die(mysqli_error());
