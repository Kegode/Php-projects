                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								$query_nursery = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Nursery'")or die(mysql_error());
								...
								<?php 
								$query_primary = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Primary'")or die(mysql_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>PRIMARY STUDENTS</strong>
										...
										<?php 
								$query_secondary = mysqli_query($connection," select * from students, class where students.class = class.class_name AND class.category ='Secondary'")or die(mysql_error());
