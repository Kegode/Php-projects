...
<!--		<img src="images/flag.png">-->
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li><a href="report_summary.php"><i class="icon-chevron-right icon-large"></i><i class="icon-table icon-large"></i> Payments Summary </a></li>
						<li class="active"><a href="activity_log.php"><i class="icon-chevron-right icon-large"></i><i class="icon-file icon-large"></i> Activity Log</a></li>
                    </ul>
	</center>
            </div>