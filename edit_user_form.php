   <div class="row-fluid">
       <a href="class.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Edit User</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($connection,"select * from users where user_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($connection,"update users set username = '$uname',firstname ='$fname', lastname='$lname',status='$status' where user_id = '$get_id' ")or die(mysqli_error());
?>
