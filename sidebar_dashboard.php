...
<!--			<img src="images/neg1.png">-->
	<center>
<!--		<img src="images/logo.png" id="logo">-->
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						<li class="active"><a href="dashboard.php"><i class="icon-chevron-right icon-large"></i><i class="icon-home icon-large"></i> Statistics</a></li>
						<li ><a href="students.php"><i class="icon-chevron-right icon-large"></i><i class="icon-group icon-large"></i> Students</a></li>
						<li><a href="add_class.php"><i class="icon-chevron-right icon-large"></i><i class="icon-th-list icon-large"></i> Class</a></li>
